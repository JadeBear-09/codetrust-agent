...
def build_parser() -> argparse.ArgumentParser:
    ...
    verify = subparsers.add_parser("verify", help="Analyze ticket and unified diff")
    verify.add_argument("--ticket", type=Path, required=True, help="Ticket or acceptance criteria")
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = verify_change(ticket, diff, offline=args.offline)
